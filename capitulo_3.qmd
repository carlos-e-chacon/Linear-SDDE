...
La solución de la @eq-sdde puede expresarse en forma integral utilizando el Cálculo de Itô [@oksendal2003stochastic]:
...
La implementación del esquema de Euler-Maruyama para SDDEs requiere especial atención al manejo del historial pasado. El @alg-euler presenta una implementación eficiente:
